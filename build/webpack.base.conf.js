...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      components: isAdmin ?
        resolve("code/admin/src/components") : resolve("code/client/src/components"),
      style: isAdmin ?
        resolve("code/admin/src/styles") : resolve("code/client/src/style"),
      views: isAdmin ?
        resolve("code/admin/src/views") : resolve("code/client/src/views"),
      store: isAdmin ?
        resolve("code/admin/src/store") : resolve("code/client/src/store"),
      api: isAdmin ?
        resolve("code/admin/src/api") : resolve("code/client/src/api"),
      utils: isAdmin ?
        resolve("code/admin/src/utils") : resolve("code/client/src/utils"),
    },
  },
  plugins: [
  ...
  module: {
    rules: [{
        ...
        loader: "babel-loader",
        include: isAdmin ?
          resolve("code/admin/src") : resolve("code/client/src"),
      },
      {
        test: /\.vue$/,
        loader: "vue-loader",
